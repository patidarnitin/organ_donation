	...
	<body>
		<!--start-wrap-->
			...
			<div class="header">
				...
				<!--start-logo-->
				<div class="logo">
					<a href="index.html" style="font-size: 30px;">Organ Donation</a>
				</div>
				<!--end-logo-->
				<!--start-top-nav-->
				<div class="top-nav">
			...
			<!--start-image-slider---->
					<div class="image-slider">
					    ...
					    <ul class="rslides" id="slider1">
					      <li><img src="images/pp12.png" alt="" ></li>
		    ...
		    <div class="content-grids">
				...
				<div class="listview_1_of_3 images_1_of_3">
					...
					<div class="text list_1_of_2">
						  ...
						  <div class="button"><span><a href="register.php">Click Here</a></span></div>
				    </div>
				</div>
				...
				<div class="listview_1_of_3 images_1_of_3">
					...
					<div class="text list_1_of_2">
						  ...
						  <div class="button"><span><a href="Hlogin.php">Click Here</a></span></div>
					</div>
				</div>
