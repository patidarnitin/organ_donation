			...
			<div id="collapseTwo" class="collapse collapse" aria-labelledby="headingTwo" data-parent="#accordion">
				<div class="card-body">
					...
					<center>
						<div>
							<form action="" method="POST">
								<a class="btn btn-primary" style="width: 25%;" type="submit" href="patient_list.php">patient list</a>
							</form>
						</div>
					</center>
				</div>
			...
			<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
				<div class="card-body">
					...
					<center>
						<div>
							<form action="" method="POST">
								<a class="btn btn-primary" style="width: 25%;" type="submit" href="available_organ.php">Organs Available</a>
							</form>
						</div>
					</center>
					<br>
					...
					<center>
						<div>
							<form action="" method="POST">
								<a class="btn btn-primary" style="width:25%" type="submit" href="donor_list.php">Donor List</a>
							</form>
						</div>
					</center>
					<br>
					<center>
						<div>
							<form action="" method="POST">
								<a class="btn btn-primary" style="width:25%" type="submit" href="HShow_Book.php">Pending Bookings</a>
							</form>
						</div>
					</center>
					<br>
					<center>
						<div>
							<form action="" method="POST">
								<a class="btn btn-primary" style="width:25%" type="submit" href="HAShow_Book.php">Accepted Bookings</a>
							</form>
						</div>
					</center>
					<br>
					<center>
						<div>
							<form action="" method="POST">
								<a class="btn btn-primary" style="width:25%" type="submit" href="HRShow_Book.php">Rejected Bookings</a>
							</form>
						</div>
					</center>
				</div>
      ...
      <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
				<div class="card-body">
					...
					<center>
						<div>
							<form action="" method="POST">
								<a class="btn btn-primary" style="width: 25%;" type="submit" href="transplant.php"> Transplants History </a>
							</form>
						</div>
					</center>
					<br>
      ...
      <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
				<div class="card-body">
					...
					<center>
						<div>
							<form action="" method="POST">
								<a class="btn btn-primary" style="width: 25%;" type="submit" href="adddaoctor.php">Add Assistance Doctor</a>
							</form>
						</div>
					</center>
                    ...
                    <center>
						<div>
							<form action="" method="POST">
								<a class="btn btn-primary" style="width: 25%;" type="submit" href="searchHhospital_byname.php">
					...
					<center>
						<div>
							<form action="" method="POST">
								<a class="btn btn-primary" style="width: 25%;" type="submit" href="hhospital_list.php">
                                    Hospital List</a >
							</form>
						</div>
					...
					<center>
						<div>
							<form action="" method="POST">
								<a class="btn btn-primary" style="width: 25%;" type="submit" href="doctor_list.php">
                                    Doctor List</a >
							</form>
						</div>
