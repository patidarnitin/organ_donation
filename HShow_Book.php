    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w790">
            <div class="card card-4">
                <div class="card-body">
                <h2 class="title">Pending Booking List</h2>
                ...
                $db = mysqli_select_db($connection,'organ_donation');
                    ...
                    $query = "SELECT * from booking_req where Hospital_ID='$HID' and status='Pending'";
                    ...
                    while($row=mysqli_fetch_array($query_run)){
                        ?>
                             <tr>
                                  ...
                                  <td><a href="Book_Accept.php?BID=<?php echo $row['ID'];?>" color='blue'>Accept</a> / <a href="Book_Reject.php?BID=<?php echo $row['ID'];?>" color='blue'>Reject</a></td>
